      ...
      <div className="relative z-10 w-full max-w-[1400px] px-6 flex flex-col items-center justify-center h-full pt-20">
        ...
        >
          ...
          <h1 className="relative font-circus leading-[0.9] tracking-normal select-none group cursor-default">
             ...
             {/* Subtext */}
             <span className="block text-[8vw] md:text-[90px] font-circus text-transparent bg-clip-text bg-gradient-to-b from-primary to-red-900 relative z-20 -mt-2 md:-mt-8 tracking-widest uppercase transform skew-x-[-5deg]">
                ROLEPLAY
             </span>
          </h1>
        </div>
